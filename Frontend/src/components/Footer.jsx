      ...
      <div className="footer-container">
        <div className="footer-brand">
          ...
          <div className="social-row">
            ...
            <a href="https://www.instagram.com/peepal.ai?igsh=MWxwOGZpMHJwYWxlMw==" aria-label="Instagram" className="social-btn">
              <svg
                width="22"
                height="22"
                viewBox="0 0 24 24"
            ...
            <a href="https://www.linkedin.com/in/peepal-ai-343149384?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" aria-label="LinkedIn" className="social-btn">
              <svg
                width="22"
                height="22"
                viewBox="0 0 24 24"
        ...
        <div className="footer-bottom">
          <span>peepal.team@gmail.com</span>
        </div>
      </div>
    </footer>
  );
